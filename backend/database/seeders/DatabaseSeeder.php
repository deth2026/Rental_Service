...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        if ($testUser && $vehicle) {
            ...
            \App\Models\BookingStatusLog::firstOrCreate(
                ['booking_id' => $booking->id, 'status' => $booking->status],
                ['changed_at' => now()]
            );
        }

        // Cities are already created in the loop above
        // Keeping this section for reference but commented out:
        // \App\Models\City::updateOrCreate(['name' => 'Phnom Penh'], ['status' => 'active']);
        // \App\Models\City::updateOrCreate(['name' => 'Siem Reap'], ['status' => 'active']);
        // \App\Models\City::updateOrCreate(['name' => 'Battambang'], ['status' => 'active']);
        // \App\Models\City::updateOrCreate(['name' => 'Sihanoukville'], ['status' => 'active']);
